...
const RULES = [
  ...
  {
    id: "title_adult",
    label: "Conținut pentru adulți (candidați)",
    hint: "Ce prinde regexul: videochat, escortă, masaj erotic, dar și „animatoare”/„dansatoare”, care sunt cuvinte nevinovate. Listă de candidați, nu verdict.",
    group: "Titluri", severity: "avertisment", weight: 6,
    tier: "scan", needs: "url,title,company,location",
    test: (d) => ADULT.test(d.title || ""),
    judgedBy: "title_adult",          // lib/judge.js spec that adjudicates these
  },
  {
    id: "title_adult_confirmed",
    label: "Conținut pentru adulți (confirmat)",
    hint: "Din candidații regexului, doar cele pe care modelul le-a citit și confirmat ca fiind conținut pentru adulți. Fiecare rând are motivul lui.",
    group: "Titluri", severity: "blocant", weight: 20,
    tier: "judge", judge: "title_adult", source: "title_adult",
  },
  {
    id: "title_contact",
